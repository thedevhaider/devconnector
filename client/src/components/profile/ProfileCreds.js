    ...
    render() {
        ...
        const expItems = experience.map(exp => (
            <li key={exp._id} className="list-group-item">
                ...
                <p>
                    {exp.location === '' ? null : (<span><strong>Position: </strong>{exp.location}</span>)}
                </p>
                <p>
                    ...
                    <div className="card card-body bg-light mb-3">
                        {expItems.length > 0 ? (
                            <ul className="list-group">{expItems}</ul>
                                ...
                                <p className="text-experience">No Experience Listed...</p>
                            )}
                    </div>
                    ...
                    <div className="card card-body bg-light mb-3">
                        {eduItems.length > 0 ? (
                            <ul className="list-group">{eduItems}</ul>
                                ...
                                <p className="text-experience">No Education Listed...</p>
                            )}
                    </div>
